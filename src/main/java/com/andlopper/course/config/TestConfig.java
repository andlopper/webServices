...
import com.andlopper.course.entities.*;
import com.andlopper.course.entities.enums.OrderStatus;
import com.andlopper.course.repositories.*;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        p1.getCategories().add(cat2); //get acessa a coleção de categorias para adicionar cat2
